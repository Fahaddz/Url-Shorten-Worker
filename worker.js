...
let index_html = "https://fahaddz.github.io/Url-Shorten-Worker/" + config.theme + "/index.html"
let result_html = "https://fahaddz.github.io/Url-Shorten-Worker/" + config.theme + "/result.html"
...
const html404 = `<!DOCTYPE html>
  ...
  <body>
    ...
    <p> <a href="https://fahaddz.com/crazypeace/Url-Shorten-Worker/" target="_self">Fork me on GitHub</a> </p>
  </body>
  </html>`
...
async function handleRequest(request) {
  ...
  if (!path) {
    return Response.redirect("https://555094468.xyz/", 302)
